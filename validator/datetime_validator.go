...
func TimezoneValidator(key string) Validator {
	return func(value interface{}) error {
		...
		if !utils.ContainsString(timezones, stringValue) {
			return gohttplib.NewError(key, "Invalid timezone", "INVALID_TIMEZONE_ERROR", nil)
		}
		return nil
	}
}
...
func DateTimeValidator(key string, t *time.Time) Validator {
	return func(value interface{}) error {
		...
		if err != nil {
			return gohttplib.NewError(key, "Invalid datetime", "INVALID_DATETIME_ERROR", nil)
		}
		return nil
	}
}
